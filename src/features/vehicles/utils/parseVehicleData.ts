...
export const vinVehicleDataSchema = z.object({
  ...
  engine: z.object({
    ...
    horsepower: z.number(),
    torque: z.number(),
    totalValves: z.number(),
    type: z.string(),
    code: z.string(),
    compressorType: z.string(),
    rpm: z.object({
      horsepower: z.number(),
      torque: z.number(),
    }),
  ...
  transmission: z.object({
    ...
    equipmentType: z.string(),
    availability: z.string(),
    automaticType: z.string(),
    transmissionType: z.string(),
    numberOfSpeeds: z.string(),
  }),
  drivenWheels: z.string(),
  numOfDoors: z.string(),
  options: z.array(
    z.object({
      category: z.string(),
  ...
  price: z.object({
    ...
    estimateTmv: z.boolean(),
  }),
  categories: z.object({
    primaryBodyType: z.string(),
    market: z.string(),
    crossover: z.string(),
    epaClass: z.string(),
